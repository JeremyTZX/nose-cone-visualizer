...
## How to Run
1. Download both `NoseConeVisualizer_batch.m` and `nosecone_inputs_batch.xlsx`, and ensure that they are both saved in the same folder. DO NOT change the Excel file's name.
